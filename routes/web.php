...
use App\Http\Controllers\Pengaturangaris;
...
Route::group([ "middleware" => ['auth:sanctum', 'verified'] ], function() {
    ...
    Route::get('/pengaturangaris', [ Pengaturangaris::class, "index_view" ])->name("pengaturangaris");
    ...
    Route::get('/setting', [ Setting::class, "index_view" ])->name("setting");
